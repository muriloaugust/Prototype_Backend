...
from augusto_prototype_backend.db import base
from augusto_prototype_backend.db.session import get_session
from augusto_prototype_backend.app import config
from augusto_prototype_backend.lib.redis import get_redis_connection
...
def testdatabase(testdatabase_factory):
    # testdatabase_factory comes from augusto-python-lib
...
def fast_password_hashing(mocker, request):
    ...
    mocker.patch('augusto_prototype_backend.service.authentication.password.crypt_context', fast_crypt_context)
